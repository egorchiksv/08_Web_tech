    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $startData['age'] ?> лет (<?php echo $startData['days'] ?> дней)</p>
          <hr>

          <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Навыки</b></p>
          <p>	<?php echo $skills['skill_name'][0]; ?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job['job_data'][0]; ?></h6></span></h6>
          <p><p><?php echo $job['job_info'][0]; ?></p></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job['job_name'][1]; ?></b></h5></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
          <?php echo $job['job_data'][1]; ?></h6>
          <p><?php echo $job['job_info'][1]; ?></p>
          <hr>
        </div>
        <div class="w3-container">
          ...
          <p><?php echo $job['job_info'][2]; ?> </p><br>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>
          <?php echo $job['job_name'][3]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job['job_data'][3]; ?></h6></span></h6>
          <p><p><?php echo $job['job_info'][3]; ?></p></p>
          <hr>
        </div>
      </div>
